...
# ground_truth = "/home/v/4th Final Pros/Code/Galves_data/Galveston_evaluation_certificate3.csv"
# ground_truth = "/home/v/4th Final Pros/Code/data/Gal_measure_file/Galveston_evaluation_certi_combined.csv"
# ground_truth = "/home/v/4th Final Pros/Code/ALl_galveston_building/building_footprint_DEM.csv"
# ground_truth = "/home/v/4th Final Pros/Code/ALl_galveston_building/building_footprint_DEM_V3.csv"
ground_truth = "/home/v/4th Final Pros/Code/ALl_galveston_building/Gal_ft.csv"
# ground_truth = "/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/gal_ffe_camera_dem_1.csv"
# ground_truth = "/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/gal_ffe_camera_dem_2.csv"
# ground_truth = "/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/gal_ffe_camera_dem_3.csv"
# ground_truth = "/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/gal_ffe_camera_dem_4.csv"
EC_df = pd.read_csv(ground_truth)
EC_df = EC_df.set_index("ID")

# detected_dir = r'..\Data\3_Detected_doors'
# detected_dir = "Galves_data/Gal_5/det_doors_5images_fov55"
detected_dir = '/media/v/Elements SE/Galv_building_tected_doors'
# detected_dir = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/detected_1_30_new_Gal_5imgs'
# detected_dir = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/detected_2_30_new_Gal_5imgs'
# detected_dir = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/detected_3_30_new_Gal_5imgs'
# detected_dir = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/detected_4_30_new_Gal_5imgs'
...
def process_detected():
    ...
    # measure_file = '/home/v/4th Final Pros/Code/Galves_data/Gal_5/measurements.csv'
    measure_file = '/home/v/4th Final Pros/Code/ALl_galveston_building/building_footprint_DEM_FFE_result.csv'
    # measure_file = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/MEASURE_gal_ffE_1.csv'
    # measure_file = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/MEASURE_gal_ffE_2.csv'
    # measure_file = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/MEASURE_gal_ffE_3.csv'
    # measure_file = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/MEASURE_gal_ffE_4.csv'
    measurement_df.to_csv(measure_file, index=False)



def process_detected_3():
    measurement_df = pd.DataFrame(columns=column_names)
    ...
    for idx, txt in enumerate(dets_txts[0:]):
        ...
        EC_id = basename.split("_")[0]
        EC_id = int(EC_id)
        #The "ID" IN The EC file "Gal_ft.csv" is used as the index of dataframe
        # and also the "EC_id" as the prefix of the pics & txts
        # Remind that there are 29000 more building footprints but by downloading the GSVs and Depthmaps seperately
        # Maybe for one "EC-id "record the GSV is downloaded but the correspoding depthma EC file record is not filled
        # SO they have to be matched so one GSV---------One single record in the Galv_ft.csv
        # THey match using "EC_id" which is set in the initial record ( building_footprints.csv ) for
        # downloading the GSV and depthmap
        if EC_id not in EC_df.index:
            continue
        ...
        for o in objects_fileds:
            try:
                ...
                lowest_door_idx = measurement_df[measurement_df['edge'] == 'Not_at_edge'].groupby("EC_id")[
                    "FFE_gsv_m"].idxmin()
                ...
                measure_file = '/home/v/4th Final Pros/Code/ALl_galveston_building/FFE_result.csv'
...
def process_detected_2():
    measurement_df = pd.DataFrame(columns=column_names)
    measure_file = '/home/v/4th Final Pros/Code/ALl_galveston_building/building_footprint_result2.csv'
...
def draw_historgam():
    # measure_file = os.path.join(detected_dir, 'measurements.csv')
    measure_file = '/home/v/4th Final Pros/Code/data/Galveston_4spots_certi_FFE/Gal_evaluation_cert/gal_ffe_camera_dem_1.csv'
