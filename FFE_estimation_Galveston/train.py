...
# --img 1600 --batch 1 --epochs 300 --data gal_street.yaml
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/gal_street.yaml', help='data.yaml path')
...
'''
python train.py --img 1600 --batch 4 --epochs 80 --data gal_street.yaml  
 
'''

'''
python train.py --img 908 --batch 4 --epochs 80 --data gal_street.yaml  
