...
# 'OBJECTID', 'Join_Count', 'TARGET_FID', 'Parcel_ID', 'Shape_Leng', 'BASEELEV', 'BLDGHEIGHT', 'area_m2', 'image', 'panoId', 'FFE_gsv_m', 'distance', 'camera_h', 'camera_dem', 'pano_lat', 'pano_lon', 'target_lat', 'target_lon', 'image_date', 'STATIC_BFE', 'Under_fld', 'image_1', 'panoId_1', 'EC_id', 'confidence', 'col', 'bottom_row', 'top_row', 'FFE_gsv_m_1', 'EC_FFE_m', 'error_m', 'delta_h', 'distance_1', 'sink_dista', 'camera_h_1', 'camera_dem_1', 'phi,pano_lat_1', 'pano_lon_1', 'target_lat_1', 'target_lon_1', 'target_ele', 'image_date_1', 'edge', 'is_lowest_', 'Shape_Length', 'Shape_Area'
# OBJECTID,Join_Count,TARGET_FID,Parcel_ID,Shape_Leng,BASEELEV,BLDGHEIGHT,area_m2,image,panoId,FFE_gsv_m,distance,camera_h,camera_dem,pano_lat,pano_lon,target_lat,target_lon,image_date,STATIC_BFE,Under_fld,image_1,panoId_1,EC_id,confidence,col,bottom_row,top_row,FFE_gsv_m_1,EC_FFE_m,error_m,delta_h,distance_1,sink_dista,camera_h_1,camera_dem_1,phi,pano_lat_1,pano_lon_1,target_lat_1,target_lon_1,target_ele,image_date_1,edge,is_lowest_,Shape_Length,Shape_Area
...
cost_df = pd.DataFrame(columns=['FID',
                                ...
                                # 'OBJECTID', 'Join_Count', 'TARGET_FID', 'Parcel_ID', 'Shape_Leng',
                                #                             'BASEELEV', 'BLDGHEIGHT', 'area_m2', 'image', 'panoId', 'FFE_gsv_m', 'distance',
                                #                             'camera_h', 'camera_dem', 'pano_lat',
                                #                             'pano_lon', 'target_lat', 'target_lon', 'image_date', 'STATIC_BFE', 'Under_fld',
                                # 'image_1', 'panoId_1',
                                # 'EC_id', 'confidence', 'col', 'bottom_row', 'top_row', 'FFE_gsv_m_1', 'EC_FFE_m',
                                # 'error_m', 'delta_h',
                                ...
                                # =============== below new cost info==================================
                                'area_m2', 'area_ft2', 'FFE_gsv_m_1', 'FFE_gsv_ft',
                                'STATIC_BFE',
                                'FFE_need_Elevate',
...
for index, row in ffe_df.iterrows():
    OBJECTID, Join_Count, TARGET_FID, Parcel_ID, Shape_Leng, BASEELEV, BLDGHEIGHT, area_m2, image, panoId, FFE_gsv_m_1, distance, camera_h, camera_dem, pano_lat, pano_lon, target_lat, target_lon, image_date, STATIC_BFE, Under_fld = \
        row['OBJECTID'], row['Join_Count'], row['TARGET_FID'], row['Parcel_ID'], row['Shape_Leng'], row['BASEELEV'], \
        row['BLDGHEIGHT'], row[
            'area_m2'], row['image'], row['panoId'], row['FFE_gsv_m_1'], row['distance'], row['camera_h'], row[
            'camera_dem'], \
    ...
    area_m2, FFE_gsv_m, STATIC_BFE = row['area_m2'], row['FFE_gsv_m_1'], row['STATIC_BFE']
    ...
    df_tmp = pd.DataFrame([[OBJECTID, Join_Count, TARGET_FID, Parcel_ID, Shape_Leng,
                            BASEELEV, BLDGHEIGHT, area_m2, image, panoId, FFE_gsv_m,
                            distance, camera_h, camera_dem, pano_lat, pano_lon,
                            target_lat, target_lon, image_date, STATIC_BFE, Under_fld,
                            # new cost value below
                            area_m2, area_ft2, FFE_gsv_m_1, FFE_gsv_ft, STATIC_BFE, FFE_need_Elevate,
...
cost_df.to_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\above1_5feet_Galvest_cost_FFE_2022_6_3.csv')
