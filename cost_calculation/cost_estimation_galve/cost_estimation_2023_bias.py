# FID,FID_1,OBJECTID,area_m2,image,panoId,EC_id,confidence,col,bottom_row,top_row,
# FFE_gsv_m,delta_h,distance,Under_fld,camera_h,camera_dem,phi,pano_lat,pano_lon,target_lat,target_lon,
...
# ffe_df = pd.read_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\Building_footprints_220604.csv')

# ffe_df = pd.read_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\Building_footprints_remove_time&wrong detections_220610.csv')

ffe_df = pd.read_csv(r'/media/v/Elements SE/A_CUHK/DTM_HK/cost_estimation_galve/Building_footprints_remove_time&wrong detections_220610.csv')

# 'OBJECTID', 'Join_Count', 'TARGET_FID', ', 'Shape_Leng', 'BASEELEV', 'BLDGHEIGHT', 'area_m2', 'image', 'panoId', 'FFE_gsv_m', 'distance', 'camera_h', 'camera_dem', 'pano_lat', 'pano_lon', 'target_lat', 'target_lon', 'image_date', 'STATIC_BFE', 'Under_fld', 'image_1', 'panoId_1', 'EC_id', 'confidence', 'col', 'bottom_row', 'top_row', 'FFE_gsv_m', 'EC_FFE_m', 'error_m', 'delta_h', 'distance_1', 'Under_fld', 'camera_h_1', 'camera_dem_1', 'phi,pano_lat_1', 'pano_lon_1', 'target_lat_1', 'target_lon_1', 'target_ele', 'image_date_1', 'edge', 'is_lowest_', 'Shape_Length', 'Shape_Area'
# OBJECTID,Join_Count,TARGET_FID,Shape_Leng,BASEELEV,BLDGHEIGHT,area_m2,image,panoId,FFE_gsv_m,distance,camera_h,camera_dem,pano_lat,pano_lon,target_lat,target_lon,image_date,STATIC_BFE,Under_fld,image_1,panoId_1,EC_id,confidence,col,bottom_row,top_row,FFE_gsv_m,EC_FFE_m,error_m,delta_h,distance_1,Under_fld,camera_h_1,camera_dem_1,phi,pano_lat_1,pano_lon_1,target_lat_1,target_lon_1,target_ele,image_date_1,edge,is_lowest_,Shape_Length,Shape_Area


# FID,TARGET_FID,BASEELEV,BLDGHEIGHT,area_m2,image,panoId,distance,camera_h,camera_dem,
# pano_lat,pano_lon,target_lat,
# target_lon,image_date,STATIC_BFE,Under_fld,EC_id,confidence,col,bottom_row,top_row,FFE_gsv_m,
# delta_h,distance_1,Under_fld,camera_h_1,camera_d_1,phi,pano_lat_1,pano_lon_1,target_l_1,target_l_2,
# target_ele,image_da_1,edge,is_lowest_

# FID,image,panoId,EC_id,confidence,col,bottom_row,top_row,FFE_gsv_m,delta_h,
# distance,Under_fld,camera_h,camera_dem,phi,pano_lat,pano_lon,target_lat,target_lon,target_ele,
# image_date,edge,is_lowest_,area_m2,STATIC_BFE,Under_fld
...
cost_df = pd.DataFrame(columns=['FID',
                                ...
                                # 'error_m', 'delta_h',
                                # 'distance_1', 'Under_fld', 'camera_h_1', 'camera_dem_1', 'phi,pano_lat_1',
...
# https://archive.org/details/rsmeansbuildingc0000unse/page/794/mode/1up?q=galveston
galveston_residential_location_factor_2015 = 0.81 # residential

galveston_building_systems_location_factor_2015 = 0.852 #total
galveston_building_systems_location_factor_2021 = 0.838  # building system
...
# 真正的building cost index ENR
# https://digital.bnpmedia.com/publication/?m=39147&i=742817&view=articleBrowser&article_id=4244030&search=COST%20Index&ver=html5




# https://digital.bnpmedia.com/publication/?i=701229&article_id=3985354&view=articleBrowser
#ENR COST
...
# 'FID',
# ', 'area_m2', 'image', 'panoId',
# 'confidence', 'col', 'bottom_row', 'top_row', 'FFE_gsv_m', 'delta_h',
# 'camera_dem', 'phi', 'pano_lat', 'pano_lon', 'target_lat', 'STATIC_BFE', 'Under_fld'
# 'target_lat','target_lon', 'image_date',


for index, row in ffe_df.iterrows():
    FID,  area_m2, image, panoId, FFE_gsv_m, camera_dem, pano_lat, pano_lon, target_lat, target_lon, image_date, STATIC_BFE, Under_fld = \
        row['FID'], \
    ...
    # print(FID, FID_1, OBJECTID,  area_m2, image, panoId, EC_id, confidence, col, bottom_row, top_row,
    #       FFE_gsv_m, delta_h, distance, Under_fld, camera_h, camera_dem, phi, pano_lat, pano_lon, target_lat,
...
# ==============================  TO TEST THE （-8.8，8.5）ange
    FFE_gsv_ft = FFE_gsv_ft - 0.079
    # FFE_gsv_ft = FFE_gsv_ft + 0.256
    ...
    # cost_2009_ENR = cost_1998_ENR * (
    #         ENR_BCI_2009 / ENR_BCI_1998) * galveston_building_systems_location_factor_2015
    cost_2015_ENR = cost_1998_ENR * (
            ENR_BCI_2015 / ENR_BCI_1998) * galveston_building_systems_location_factor_2015
    cost_2021_ENR = cost_1998_ENR * (
            ENR_Construction_index_2021 / ENR_Construction_index_1998) * galveston_building_systems_location_factor_2021
...
# cost_df.to_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\above1_5feet_Galvest_cost_FFE_2022_6_5.csv')
# cost_df.to_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\above1_5feet_Galvest_cost_FFE_2022_6_10.csv')
# cost_df.to_csv(r'F:\A_CUHK\DTM_HK\cost_estimation_galve\above1_5feet_Galvest_cost_FFE_2022_6_23+++8.csv')
# cost_df.to_csv(r'/media/v/Elements SE/A_CUHK/DTM_HK/cost_estimation_galve/above1_5feet_Galvest_cost_FFE_2022_6_23----2.csv')
cost_df.to_csv(r'/media/v/Elements SE/A_CUHK/DTM_HK/cost_estimation_galve/above1_5feet_0.079.csv')
# cost_df.to_csv(r'/media/v/Elements SE/A_CUHK/DTM_HK/cost_estimation_galve/above1_5feet_0.256.csv')
